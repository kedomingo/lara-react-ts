                ...
                <div className="sidebar-content js-simplebar">
                    ...
                    <ul className="sidebar-nav">
                        ...
                        <li className="sidebar-item">
                            <a className="sidebar-link" href="pages-settings.html">
                                <i className="align-middle" data-feather="settings"></i> <span
                        ...
                        <li className="sidebar-item">
                            <a href="#ui" data-toggle="collapse" className="sidebar-link collapsed">
                                <i className="align-middle" data-feather="briefcase"></i> <span
                    ...
                    <div className="sidebar-cta">
                        <div className="sidebar-cta-content">
                            ...
                            <a href="https://adminkit.io/pricing" target="_blank" className="btn btn-primary btn-block">Upgrade
                                to
                                Pro</a>
                        </div>
                    </div>
