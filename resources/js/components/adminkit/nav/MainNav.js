                    ...
                    <ul className="navbar-nav navbar-align">
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <a className="nav-link dropdown-toggle d-none d-sm-inline-block" href="#"
                               data-toggle="dropdown">
                                <img src="img/avatars/avatar.jpg" className="avatar img-fluid rounded mr-1"
                                     alt="Charles Hall"/>
                            ...
                            <div className="dropdown-menu dropdown-menu-right">
                                ...
                                <a className="dropdown-item" href="pages-settings.html">
                                    <i className="align-middle mr-1" data-feather="settings"></i> Settings
                                    & Privacy
                                </a>
                                <a className="dropdown-item" href="#">
                                    <i className="align-middle mr-1" data-feather="help-circle"></i> Help Center
                                </a>
                                <div className="dropdown-divider"></div>
