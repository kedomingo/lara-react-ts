                        ...
                        <div className="card-body">
                            <form>
                                ...
                                <div className="form-group">
                                    ...
                                    <textarea className="form-control" placeholder="Textarea" rows="1"></textarea>
                                </div>
                                <div className="form-group">
                                    <label className="form-label w-100">File input</label>
                                    <input type="file"/>
                                    <small className="form-text text-muted">Example block-level help text
                                        here.</small>
                                </div>
                                <div className="form-group">
                    ...
                    <div className="card">
                        ...
                        <div className="card-body">
                            <form>
                                ...
                                <div className="form-group row">
                                    <label className="col-form-label col-sm-2 text-sm-right">Textarea</label>
                                    <div className="col-sm-10">
                                ...
                                <fieldset className="form-group">
                                    <div className="row">
                                        <label
                                            className="col-form-label col-sm-2 text-sm-right pt-sm-0">Radios</label>
                                        <div className="col-sm-10">
                                            <div className="custom-controls-stacked">
                                                <label className="custom-control custom-radio">
                                                    <input name="custom-radio-3" type="radio"
                                                           className="custom-control-input" checked/>
                                                    <span className="custom-control-label">Default radio</span>
                                                </label>
                                                <label className="custom-control custom-radio">
                                                    <input name="custom-radio-3" type="radio"
                                                           className="custom-control-input"/>
                                                    <span
                                                        className="custom-control-label">Second default radio</span>
                                                </label>
                                                <label className="custom-control custom-radio">
                                                    <input name="custom-radio-3" type="radio"
                                                           className="custom-control-input" disabled/>
                                                    <span className="custom-control-label">Disabled radio</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="form-group row">
                                    <label
                                        className="col-form-label col-sm-2 text-sm-right pt-sm-0">Checkbox</label>
                                    <div className="col-sm-10">
                        ...
                        <div className="card-body">
                            <form className="form-inline">
                                ...
                                <div className="custom-control custom-checkbox mb-1 mr-sm-2">
                                    ...
                                    <label className="custom-control-label" for="customControlInline">Remember
                                        me</label>
                                </div>
