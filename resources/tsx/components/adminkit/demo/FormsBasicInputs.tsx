        ...
        <>
            ...
            <div className="row">
              ...
              3
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h5 className="card-title mb-0">Custom checkboxes</h5>
                        </div>
                        <div className="card-body">
                            <label className="custom-control custom-checkbox">
                                <input type="checkbox" className="custom-control-input"/>
                                <span className="custom-control-label">Custom checkbox</span>
                            </label>
                            <label className="custom-control custom-checkbox">
                                <input type="checkbox" className="custom-control-input" disabled checked/>
                                <span className="custom-control-label">Disabled custom checkbox</span>
                            </label>
                            <label className="custom-control custom-checkbox">
                ...
                <div className="col-12 col-lg-6">
                    <div className="card">
                        ...
                        <div className="card-body">
                            <div>
                                <label className="form-check">
                                    <input className="form-check-input" type="radio" value="option1" name="radios-example"
                                           checked/>
                                    <span className="form-check-label">
              Option one is this and that&mdash;be sure to include why it's great
            </span>
              ...
              Option two can be something else and selecting it will deselect option one
                                ...
                                <label className="form-check">
                                    <input className="form-check-input" type="radio" value="option3" name="radios-example"
                                           disabled/>
                                    <span className="form-check-label">
              Option three is disabled
                            ...
                            <div>
                                <label className="form-check form-check-inline">
                                    <input className="form-check-input" type="radio" name="inline-radios-example"
                                           value="option1"/>
                                    <span className="form-check-label">
              1
            </span>
                    ...
                    <div className="card">
                        ...
                        <div className="card-body">
                            <label className="custom-control custom-radio">
                                <input name="custom-radio" type="radio" className="custom-control-input"/>
                                <span className="custom-control-label">Toggle this custom radio</span>
                            </label>
                            <label className="custom-control custom-radio">
                                <input name="custom-radio" type="radio" className="custom-control-input"/>
                                <span className="custom-control-label">Or toggle this other custom radio</span>
                            </label>
                            <fieldset disabled>
                                <label className="custom-control custom-radio">
                                    <input name="custom-radio-2" type="radio" className="custom-control-input" checked/>
                                    <span className="custom-control-label">Disabled custom radio</span>
                                </label>
                                <label className="custom-control custom-radio">
                                    <input name="custom-radio-2" type="radio" className="custom-control-input"/>
                                    <span className="custom-control-label">Other disabled custom radio</span>
                                </label>
                            </fieldset>
                        </div>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <div className="card-body">
                            <div className="custom-control custom-switch">
                                ...
                                <label className="custom-control-label" for="customSwitch1">Toggle this switch
                                    element</label>
                            </div>
                            <div className="custom-control custom-switch">
                                <input type="checkbox" className="custom-control-input" disabled id="customSwitch2"/>
                                <label className="custom-control-label" for="customSwitch2">Disabled switch
                                    element</label>
                            </div>
                        </div>
                    </div>
